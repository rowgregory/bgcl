...
const MinNMatchExplaination = () => {
  return (
    <div className="bg-neutral-900 border-2 border-indigo-500 rounded-2xl p-6 ring-indigo-400">
      <div className="bg-linear-to-r from-indigo-500 to-violet-600 text-white px-3 py-1 rounded-full text-sm font-medium inline-block mb-4">
        BUILD YOUR APP
      </div>
      <h3 className="text-xl font-bold text-white mb-3">
        Interactive App Feature Selector
      </h3>
      <div className="text-3xl font-bold bg-linear-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent mb-3">
