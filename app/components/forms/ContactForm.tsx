      ...
      <div className="dark:bg-neutral-900 bg-white dark:border-neutral-800 border-neutral-200 p-8 rounded-xl border">
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold dark:text-white text-neutral-900 mb-2">First Name</label>
              <input
                type="text"
                name="firstName"
            ...
            <div>
              <label className="block text-sm font-semibold dark:text-white text-neutral-900 mb-2">Last Name</label>
              <input
                type="text"
                name="lastName"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold dark:text-white text-neutral-900 mb-2">Email Address</label>
              <input
                type="email"
                name="email"
                value={inputs.email ?? ''}
            ...
            <div>
              <label className="block text-sm font-semibold dark:text-white text-neutral-900 mb-2">Phone Number</label>
              <input
                type="tel"
                name="phone"
                value={inputs.phone ?? ''}
