...
const CountdownEditor: FC<IHeroStudioEditor> = ({ activeHero, updateActiveHero }) => {
  return (
    <div className="border-b border-neutral-800 dark:bg-neutral-900/50 bg-neutral-50 p-4">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-xs font-semibold text-neutral-400 uppercase tracking-wide">Countdown Timer</h3>
      ...
      {activeHero.showCountdown && (
        <div className="space-y-3">
          <div>
            <label className="block text-xs text-neutral-400 mb-2">Countdown Label</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs text-neutral-400 mb-2">Target Date</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-xs text-neutral-400 mb-2">Position</label>
