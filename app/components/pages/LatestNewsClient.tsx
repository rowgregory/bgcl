...
export default function LatestNewsClient({ newsletters, news }: { newsletters: INewsletter[]; news: INews[] }) {
  ...
  return (
    <div className="dark:bg-neutral-950 bg-white">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-sky-600 focus:text-white focus:rounded-lg focus:font-semibold"
      >
