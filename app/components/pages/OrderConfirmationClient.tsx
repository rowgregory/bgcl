...
import { generateTicketPDF } from '@/app/lib/pdf/generateTicketPDF'
...
import { Calendar, ArrowLeft, Download, User, MapPin } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white dark:bg-neutral-900">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            onClick={() => (isTicket ? handleGenerateTicketPDF() : window.print())}
          ...
          >
            ...
            {isTicket ? 'Download Tickets' : 'Save Receipt'}
          </button>
          <Link
            href="/"
