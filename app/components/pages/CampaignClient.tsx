    ...
    <div className="min-h-screen dark:bg-neutral-950 bg-white">
      ...
      <div className="px-6 md:px-12 py-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            {/* Progress Card */}
            <div className="dark:bg-linear-to-b dark:from-neutral-900 dark:to-neutral-950 bg-linear-to-b from-neutral-50 to-white dark:border-neutral-800 border-neutral-200 rounded-xl p-8 space-y-6 sticky top-24 shadow-xl border">
              <div className="space-y-4">
              ...
              <div className="space-y-3 py-6 dark:border-neutral-800 border-neutral-200 border-y">
                <div className="flex items-center justify-between group">
                  ...
                  <p className="dark:text-white text-neutral-900 font-black">${remaining.toFixed(1)}K</p>
                </div>
