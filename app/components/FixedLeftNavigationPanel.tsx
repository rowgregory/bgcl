...
import { magicChargeMana2 } from "../lib/constants/sound-effects";
            ...
            <Link href={item.linkKey} key={item.id}>
              ...
              ${
                selectedPage === item.label
                  ? "bg-gradient-to-r from-violet-600/20 via-indigo-600/20 to-indigo-600/20 text-violet-400 border border-purple-600/30"
      ...
      {!isNavigationCollapsed ? (
        ...
        >
          <div className="flex items-center space-x-3 p-3 bg-neutral-800/50 rounded-xl">
            <div className="w-8 h-8 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold">
        ...
        >
          <div className="py-3 flex items-center justify-center bg-neutral-800/50 rounded-xl">
            <div className="w-8 h-8 bg-gradient-to-r from-violet-500 via-indigo-500 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold">
              {data?.user?.role === "SUPERUSER" ? (
                <Crown className="w-4 h-4" />
              ) : data?.user?.role === "ADMIN" ? (
                <Shield className="w-4 h-4" />
