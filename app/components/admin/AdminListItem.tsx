...
import { deleteCampaign } from '@/app/lib/actions/campaign/deleteCampaign'
import { deleteClosing } from '@/app/lib/actions/closing/deleteClosing'
import { deleteNewsletter } from '@/app/lib/actions/newsletter/deleteNewsletter'
import { deleteResource } from '@/app/lib/actions/club-resource/deleteResource'
...
import { archiveEvent } from '@/app/lib/actions/event/archiveEvent'
import { useRouter } from 'next/navigation'
import { unarchiveEvent } from '@/app/lib/actions/event/unarchiveEvent'
import { setOpenPartnerDrawer } from '@/app/lib/store/slices/uiSlice'
import { kebabToCamel } from '@/app/lib/utils/kebabToCamel'
import { deleteProgram } from '@/app/lib/actions/program/deleteProgram'
    ...
    >
      ...
      <div className="shrink-0 flex items-center gap-2">
        ...
        <div className="relative group/edit">
          <button
            onClick={() => (itemType === 'event' ? router.push(`/admin/capsule/events/${item.id}`) : handleEdit())}
