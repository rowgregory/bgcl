...
import { setCloseHeroStudio } from "@/app/redux/features/appSlice";
...
import HeroPreview from "../hero-studio/HeroPreview";
import SavedHeroes from "../hero-studio/SavedHeroes";
import HeightEditor from "../hero-studio/editor/HeightEditor";
import LayoutEditor from "../hero-studio/editor/LayoutEditor";
import BackgroundEditor from "../hero-studio/editor/BackgroundEditor";
import ContentEditor from "../hero-studio/editor/ContentEditor";
import CtaEditor from "../hero-studio/editor/CtaEditor";
import FloatingButtonEditor from "../hero-studio/editor/FloatingButtonEditor";
import ThermometerEditor from "../hero-studio/editor/ThermometerEditor";
import CountdownEditor from "../hero-studio/editor/CountdownEditor";
import GrowthTreeEditor from "../hero-studio/editor/GrowthTreeEditor";
import EmptyHero from "../hero-studio/EmptyHero";
import TopBannerEditor from "../hero-studio/editor/TopBannerEditor";
import FullScreenPreviewMode from "../hero-studio/FullScreenPreviewMode";
                    ...
                    <div className="w-96 border-r border-neutral-800 overflow-y-auto bg-[#1a1a24]">
                      ...
                      <div className="border-b border-neutral-800 bg-neutral-900/50 p-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateActiveHero({ name: e.target.value })
                          }
                      ...
                      <HeightEditor
                        activeHero={activeHero}
                        updateActiveHero={updateActiveHero}
                      />
