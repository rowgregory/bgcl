      ...
      <div className="max-w-6xl mx-auto px-4 py-12 lg:px-8">
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-neutral-900 dark:text-white font-semibold">{order?.type}</p>
                </div>
                {isRecurring && (
                  <>
                    <div>
        ...
        {isRecurring && (
          <motion.div
            ...
            className="p-4 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 rounded-lg mb-8"
          >
            <p className="text-sm text-blue-900 dark:text-blue-400">
              Your subscription will continue until you cancel. You can manage it anytime in your account settings.
            </p>
          </motion.div>
        )}
