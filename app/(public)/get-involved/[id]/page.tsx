      ...
      <div className="">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-4">
            ...
            <p className="text-zinc-400">{'We could not find your application.'}</p>
            <Link href="/careers">
              <button className="px-6 py-3 bg-sky-500 hover:bg-sky-600 text-white font-semibold rounded-lg transition-colors mt-6">
                Back to Careers
              </button>
            </Link>
          </motion.div>
      ...
      <div className="bg-zinc-900 border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-4">
            ...
            <p className="text-zinc-400">Thank you for applying to Boys & Girls Club of Lynn</p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="lg:col-span-1">
            {/* Status Card */}
            <div className={`border-2 rounded-lg p-6 ${statusInfo.color} sticky top-8`}>
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-zinc-300 text-sm">{statusInfo.description}</p>
            ...
            <motion.div
              ...
              className="mt-8 bg-zinc-900 border border-zinc-800 rounded-lg p-6 space-y-4"
            >
              <h3 className="text-lg font-bold text-white text-center">Questions?</h3>
              <div className="space-y-3 text-center">
                <div>
                  <p className="text-zinc-400 text-xs uppercase tracking-wider">Phone</p>
                  <a href="tel:781-593-1772" className="text-sky-400 hover:text-sky-300 font-semibold">
                    (781) 593-1772
                  </a>
                </div>
                <div>
                  <p className="text-zinc-400 text-xs uppercase tracking-wider">Email</p>
          ...
          >
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 space-y-6">
              <h3 className="text-2xl font-bold text-white">Your Application Details</h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Personal Information */}
                <div className="space-y-4">
                  <h4 className="text-sm font-semibold text-sky-400 uppercase tracking-wider">Personal Information</h4>
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-semibold text-sm break-all">{application.email}</p>
                    </div>
                    <div>
                      <p className="text-zinc-400 text-sm">Phone</p>
                      <p className="text-white font-semibold">{application.cellNumber}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <h4 className="text-sm font-semibold text-sky-400 uppercase tracking-wider">Position Information</h4>
                  <div className="space-y-3">
                    <div>
                      <p className="text-zinc-400 text-sm">Position Applied For</p>
                      <p className="text-white font-semibold">{application.positionAppliedFor}</p>
                    </div>
                    <div>
                      <p className="text-zinc-400 text-sm">Employment Type</p>
                    ...
                    <div>
                      <p className="text-zinc-400 text-sm">Hours Available</p>
                      <p className="text-white font-semibold text-sm">{application.hoursAvailable}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {application.languages && application.languages.length > 0 && (
                <div className="border-t border-zinc-700 pt-6 space-y-3">
                  <p className="text-zinc-400 text-sm">Languages Spoken</p>
            ...
            <motion.div
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 space-y-4"
            >
              ...
              {application.resumeUrl ? (
                <a
                  ...
                  className="flex items-center justify-between p-4 bg-zinc-800 border border-zinc-700 rounded-lg hover:border-sky-500 transition-colors group"
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <FileText className="w-6 h-6 text-zinc-400 group-hover:text-sky-400 transition-colors shrink-0" />
                    <div className="min-w-0">
                      <p className="text-white font-semibold truncate">{application.resumeFileName}</p>
                      <p className="text-zinc-400 text-sm">Click to view</p>
                    </div>
                  </div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
              <Link href="/careers">
                <button className="w-full px-8 py-3 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-lg transition-colors border border-zinc-700">
                  Back to Careers
                </button>
              </Link>
            </motion.div>
