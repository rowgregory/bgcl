      ...
      case "toggle":
        return (
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() =>
                handleFieldChange(sectionId, fieldId, !field.value)
              }
        ...
        return (
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleFieldChange(sectionId, fieldId, e.target.value)
              }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400">
                Changes to these settings can affect the entire platform. Make
                sure you understand the impact before saving.
              </p>
            </div>
          </div>
        </motion.div>
              ...
              <div className="space-y-6">
                {Object.entries(currentSection.fields).map(
                  ([fieldId, field]) => (
                    <div
                      key={fieldId}
                      className="pb-6 border-b border-neutral-800 last:border-b-0 last:pb-0"
                    >
