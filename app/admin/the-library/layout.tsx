...
export default function TheLibraryLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <div className="w-[calc(100vw-255px)] fixed top-18 lg:top-auto z-10 dark:bg-zinc-900/50 dark:backdrop-blur-sm dark:border-zinc-700/30 bg-white/50 backdrop-blur-sm border-neutral-200/30 border-b">
