...
const StarMap: React.FC = () => {
  ...
  const [content, setContent] = useState<ContentStructure>({
    home: {
      ...
      cta: {
        ...
        bodyText:
          "Join our community and help shape the future of Lynn's youth",
    ...
    about: {
      metadata: {
        ...
        description:
          "Learn about our history, mission, and impact in the Lynn community",
    ...
    programs: {
      metadata: {
        ...
        description:
          "Explore our youth programs including Kids Club, Teen Center, and Camp Creighton",
    ...
    events: {
      ...
      featured: {
        ...
        description:
          "Annual fundraising gala with dinner, dancing, and silent auction",
        ticketPrice: "$50",
    ...
    donate: {
      ...
      testimonial: {
        quote:
          "This club changed my life and gave me opportunities I never thought possible.",
      ...
      <div key={fieldId} className="mb-4">
        ...
        {isEditing && (
          <p className="text-xs text-neutral-500 mt-1">
            Click the checkmark to confirm changes
          </p>
        )}
      </div>
    );
  ...
  const renderSection = (
    ...
    return (
      <div
        key={sectionId}
        className="bg-neutral-900 rounded-lg border border-neutral-800 mb-4"
      >
        <button
                ...
                {Object.entries(sectionData).map(([field, value]) => {
                  if (typeof value === "string") {
                    return renderField(
                      ...
                      field,
                      value,
                      value.length > 100 ? "textarea" : "text"
                    );
                  } else if (
                    typeof value === "object" &&
                    value !== null &&
                    ...
                    return (
                      <div
                        key={field}
                        className="ml-4 pl-4 border-l-2 border-neutral-800"
                      >
                    ...
                    return (
                      ...
                      >
                        ...
                        {value.map((item, index) => (
                          <div
                            key={index}
                            className="mb-4 p-3 bg-neutral-800/50 rounded-lg"
                          >
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-xs text-neutral-500">
                                Item {index + 1}
  ...
  return (
    <div className="min-h-screen bg-neutral-950 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="bg-neutral-900 rounded-lg border border-neutral-800 p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-neutral-500">
                  {Object.keys(currentPageContent).length} sections
                </span>
              </div>
            </div>

            {/* Render all sections */}
            {Object.entries(currentPageContent).map(
              ...
              >
                <div className="bg-neutral-900 rounded-lg border border-neutral-800 p-6">
                  ...
                  <div className="bg-white rounded-lg p-6 max-h-[800px] overflow-y-auto">
                    {/* Metadata Preview */}
                    {"metadata" in currentPageContent &&
                      currentPageContent.metadata && (
                        <div className="mb-6 pb-6 border-b border-neutral-200">
                          ...
                          <div className="space-y-1">
                            <p className="text-sm font-medium text-neutral-900">
                              {currentPageContent.metadata.title}
                            </p>
                            <p className="text-xs text-neutral-600">
                              {currentPageContent.metadata.description}
                            </p>
                          </div>
                        </div>
                      )}
                      ...
                      currentPageContent.hero && (
                        <div className="mb-8">
                          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-8 text-white text-center">
                            ...
                            {"ctaText" in currentPageContent.hero &&
                    ...
                    {Object.entries(currentPageContent).map(
                      ([sectionId, sectionData]) => {
                        if (sectionId === "metadata" || sectionId === "hero")
                          return null;
                                  ...
                                  {section.amounts.map(
                                    (item, index) =>
                                      ...
                                      item !== null && (
                                        <div
                                          key={index}
                                          className="p-4 border-2 border-indigo-200 rounded-lg"
                                        >
                                          {"amount" in item &&
                                            typeof item.amount === "string" && (
                              ...
                              if (
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    {Object.entries(value as NestedObject).map(
                                      ([nestedKey, nestedValue]) => (
                                        <div key={nestedKey} className="mb-1">
                                          ...
                                          <span className="text-xs text-neutral-900 ml-2">
                                            {String(nestedValue)}
                                          </span>
                                        </div>
                                      )
        ...
        >
          Click the edit icon next to any field to modify content. Changes are
