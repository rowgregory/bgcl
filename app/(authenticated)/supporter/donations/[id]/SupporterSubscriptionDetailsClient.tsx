...
export default function SupporterSubscriptionDetailsClient({ data }: SubscriptionClientProps) {
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  <h1 className="text-4xl md:text-5xl font-black dark:text-white text-neutral-900 leading-tight">
                    {formatCurrency(item?.price.unit_amount / 100 || amount)}/
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {order?.customerPhone && (
                <div>
                  ...
                  <p className="text-lg dark:text-white text-neutral-900">{formatPhone(order.customerPhone)}</p>
                </div>
              )}
            </div>
          </motion.div>
              ...
              <div className="grid sm:grid-cols-3 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-2xl font-bold dark:text-white text-neutral-900">
                    {formatCurrency(subscription.latest_invoice.amount_paid / 100)}
                  </p>
                </div>
                <div>
