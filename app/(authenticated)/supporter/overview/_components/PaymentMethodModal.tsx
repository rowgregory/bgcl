...
export function PaymentMethodModal({ savedCards }: { savedCards: PaymentMethod[] }) {
  ...
  useEffect(() => {
    if (!isOpen) return
    reset({ ...EMPTY_PAYMENT_METHOD, isDefault: isFirstCard })
  }, [isOpen, isFirstCard, reset])
        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="w-full max-w-md overflow-hidden rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950"
            >
