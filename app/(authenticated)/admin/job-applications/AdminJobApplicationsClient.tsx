...
import { getJobApplicationStatusBadge } from '@/app/(authenticated)/admin/job-applications/_utils/getJobApplicationStatusBadge'
              ...
              {TABS.map((tab) => (
                ...
                >
                  ...
                  {tab === 'New' && stats.pending > 0 && (
                    <span className="ml-2 px-1.5 py-0.5 text-xs bg-sky-500 text-white rounded-full">
                      {stats.pending}
                    </span>
                  )}
                  {activeTab === tab && (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-6">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-2 sm:gap-6">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-sky-600 dark:text-sky-400">
                    {stats.review}
                  </span>
                </div>
