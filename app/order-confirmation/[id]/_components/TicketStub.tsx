    ...
    >
      ...
      <div className="px-4 py-3 bg-linear-to-r from-sky-600 to-sky-500 flex items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-2">
          {isRaffle && (
            <span className="text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded bg-white/20 text-white">
              Raffle
            </span>
          )}
          <span className="text-[11px] font-black tabular-nums px-2 py-1 rounded bg-white/20 text-white">
            ×{item.quantity}
          </span>
        </div>
      </div>
