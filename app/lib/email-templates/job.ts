const jobApplicationNotification = (applicantName: string, email: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>New Job Application - Boys & Girls Club of Lynn</title>
</head>
  ...
  <div style="max-width: 500px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 40px;">
      ...
      <p style="margin: 0; color: #666666; font-size: 14px; line-height: 1.6;">
        A new candidate has applied for a position at Boys & Girls Club of Lynn.
      </p>
    </div>
    ...
    <div style="margin-bottom: 48px;">
      ...
      <p style="margin: 0; color: #666666; font-size: 13px; line-height: 1.6;">
        Review the complete application, resume, and cover letter in your admin panel. Don't forget to respond to the candidate within 3-5 business days.
      </p>
    </div>
