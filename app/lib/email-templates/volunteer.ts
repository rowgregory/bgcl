const volunteerFormNotification = (firstName: string, lastName: string, email: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>New Volunteer Application - Boys & Girls Club of Lynn</title>
</head>
  ...
  <div style="max-width: 500px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 40px;">
      ...
      <p style="margin: 0; color: #666666; font-size: 14px; line-height: 1.6;">
        A new volunteer application has been submitted and requires your review.
      </p>
    </div>
...
export default volunteerFormNotification
