export const homeTextData = {
  ...
  content: {
    modal: {
      ...
      subheading:
        'Enroll your child now in our quality summer programs designed to inspire growth, learning, and community.',
      button1Link: 'https://parentportal.bgcl.org',
      button1Text: 'Register Your Child',
    ...
    facility: {
      ...
      paragraph3:
        'Our newly enhanced After School Drop In Center is equipped with a dedicated Teen area as well as the aforementioned STEAM Lab, Gym, Dance Studio, Gaming area and also a Tower Garden for our older members to test out their gardening skills! Over the next 3-4 years, we will be heading into Phase 2 of our renovations. We are looking forward to offering a Culinary program and a Rooftop garden to name a few of our proposed upgrades.'
    }
  }
}
