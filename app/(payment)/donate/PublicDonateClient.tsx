...
import { PublicDonateCheckoutForm } from '@/app/(payment)/donate/_components/PublicDonateCheckoutForm'
import { DonationFormLeftColumn } from '@/app/(payment)/donate/_components/DonationFormLeftColumn'
import { DonationFormHeader } from '@/app/(payment)/donate/_components/DonationFormHeader'
import {
  EMPTY_DONATION,
  donationSchema,
...
export function PublicDonateClient({ campaigns, name, address, savedCards, phone, isAuthed }: Props) {
