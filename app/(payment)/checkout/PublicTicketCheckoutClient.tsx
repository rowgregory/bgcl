...
import { TicketCheckoutFooter } from './_components/TicketCheckoutFooter'
...
export function PublicTicketCheckoutClient({
  savedCards,
  userAddress,
  userName,
  userEmail,
  ...
  const handleStep2 = async () => {
    ...
    await updatePhoneNumber({ phone: values.phone })
  ...
  return (
    <div className="pb-20 sm:pb-0 min-h-screen flex flex-col">
