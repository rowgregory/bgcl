...
import { deleteResource } from '@/lib/actions/club-resource/deleteResource'
...
import { setOpenEventDrawer } from '@/lib/store/slices/eventSlice'
...
import { kebabToCamel } from '@/lib/utils/kebabToCamel'
