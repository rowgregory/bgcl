    ...
    <div className="w-full mx-auto pb-40">
      ...
      >
        <h1 className="text-3xl md:text-4xl font-black dark:text-white text-neutral-900">
          {isUpdating ? 'Edit Club Resource' : 'Create Club Resource'}
        </h1>
        <p className="dark:text-neutral-400 text-neutral-600">Configure your club resource details</p>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium dark:text-neutral-300 text-neutral-700 mb-2">Url *</label>
            <input
              type="text"
              name="url"
              value={inputs.url ?? ''}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-neutral-950 border-t border-neutral-200 dark:border-neutral-800 p-6 md:p-8 z-40">
        <div className="max-w-2xl mx-auto flex flex-col md:flex-row gap-4">
          ...
          >
            {isLoading ? 'Saving...' : isUpdating ? 'Update club resource' : 'Create club resource'}
          </motion.button>
        </div>
      </div>
    </div>
