...
export const ClosingForm: FC<IForm> = ({
  errors,
  handleInput,
  handleSubmit,
  inputs,
    ...
    <div className="w-full mx-auto pb-40">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium dark:text-neutral-300 text-neutral-700 mb-2">Date *</label>
            <input
              type="text"
              name="date"
              value={inputs.date ?? ''}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-neutral-950 border-t border-neutral-200 dark:border-neutral-800 p-6 md:p-8 z-40">
        <div className="max-w-2xl mx-auto flex flex-col md:flex-row gap-4">
          ...
          >
            {isLoading ? 'Saving...' : isUpdating ? 'Update closing' : 'Create closing'}
          </motion.button>
        </div>
      </div>
    </div>
