const recurringDonationTemplate = (donorName: string, amount: number, frequency: string, orderId: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Recurring Donation Confirmed - Boys & Girls Club of Lynn</title>
</head>
  ...
  <div style="max-width: 500px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 40px;">
      <p style="margin: 0 0 24px 0; color: #1a1a1a; font-size: 16px; line-height: 1.6; font-weight: 500;">
        Thank you, ${donorName}! Your recurring donation is now active.
      </p>
    </div>
    ...
    <div style="margin-bottom: 48px; padding: 24px; border: 1px solid #e5e5e5; border-radius: 6px;">
      <div style="margin-bottom: 16px;">
        <p style="margin: 0 0 8px 0; color: #999999; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Monthly Amount</p>
        <p style="margin: 0; color: #000000; font-size: 24px; font-weight: 700;">$${(amount / 100).toFixed(2)}</p>
      </div>
      <div style="margin-bottom: 16px;">
        <p style="margin: 0 0 8px 0; color: #999999; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Frequency</p>
        <p style="margin: 0; color: #000000; font-size: 14px;">Monthly on the ${new Date().getDate()}${getOrdinalSuffix(new Date().getDate())} of each month</p>
      </div>
      <div style="margin-bottom: 0;">
        <p style="margin: 0 0 8px 0; color: #999999; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Subscription ID</p>
    ...
    <div style="margin-bottom: 48px;">
      <p style="margin: 0 0 16px 0; color: #666666; font-size: 14px; line-height: 1.8;">
        By committing to a monthly donation, you're providing consistent, reliable support that helps us plan and deliver impactful programs year-round.
      </p>
      <p style="margin: 0; color: #666666; font-size: 14px; line-height: 1.8;">
        Your generosity empowers youth through mentorship, education, sports, and community connection.
      </p>
    </div>

    <!-- Manage Subscription -->
    <div style="margin-bottom: 48px;">
      <p style="margin: 0 0 12px 0; color: #666666; font-size: 14px; font-weight: 500;">
        Need to manage your subscription?
      </p>
      <p style="margin: 0; color: #666666; font-size: 13px; line-height: 1.6;">
        You can update or cancel your recurring donation anytime by logging into your account or contacting us directly.
      </p>
    </div>
    ...
    <div style="margin-bottom: 48px;">
      <p style="margin: 0; color: #666666; font-size: 13px; line-height: 1.6;">
        <strong style="color: #1a1a1a;">Tax Information:</strong> Boys & Girls Club of Lynn is a 501(c)(3) nonprofit organization. Your donations are tax-deductible to the extent allowed by law.
      </p>
    </div>
