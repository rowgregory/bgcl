...
export interface IHero extends Omit<IHeroEntity, 'status'> {
  ...
  backgroundPosition:
    ...
    | 'bottom-left'
    | 'bottom-right'
  titleAnimation: 'fade-up' | 'fade-down' | 'fade-left' | 'fade-right' | 'scale' | 'bounce' | 'none'
  subtitleAnimation: 'fade-up' | 'fade-down' | 'fade-left' | 'fade-right' | 'scale' | 'bounce' | 'none'
  ctaAnimation: 'fade-up' | 'fade-down' | 'fade-left' | 'fade-right' | 'scale' | 'bounce' | 'none'
  ...
  floatingButtonIcon: 'none' | 'arrow' | 'phone' | 'email' | 'chat' | 'info' | 'help'
